...
export function joinLobby(
  ...
  let gameRunner: ClientGameRunner | null = null;
...
export class ClientGameRunner {
  ...
  private mouseUpHandler: ((e: MouseUpEvent) => void) | null = null;
  private mouseMoveHandler: ((e: MouseMoveEvent) => void) | null = null;
  private boatAttackHandler: ((e: DoBoatAttackEvent) => void) | null = null;
  ...
  public start() {
    ...
    this.mouseUpHandler = (e: MouseUpEvent) => this.inputEvent(e);
    this.mouseMoveHandler = (e: MouseMoveEvent) => this.onMouseMove(e);
    this.boatAttackHandler = (e: DoBoatAttackEvent) => this.doBoatAttackUnderCursor();
  ...
  public stop(saveFullGame: boolean = false) {
    ...
    // Hide and reset all game UI elements
    UIManager.resetGameUI();
    
    // Clear renderer reference
    (window as any).currentGameRenderer = null;
    
    // Clear the game view reference
    this.gameView = null as any;
  }
  ...
  private checkTileUnderCursor() {
    if (!this.lastMousePosition || !this.renderer?.transformHandler || !this.gameView || !this.isActive) return;
