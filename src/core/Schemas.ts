...
export type ClientPartyMessage = z.infer<typeof ClientPartyMessageSchema>;
export type ServerPartyMessage = z.infer<typeof ServerPartyMessageSchema>;
...
const ServerBaseMessageSchema = z.object({
  type: z.enum(["turn", "ping", "prestart", "start", "desync", "party"]),
});
...
// Party schemas - moved here before ServerMessageSchema
...
export const PartyActionSchema = z.enum(["create", "join", "leave", "update", "start_game"]);

export const ServerPartyMessageSchema = z.object({
  type: z.literal("party"),
  action: PartyActionSchema,
  partyCode: z.string().optional(),
  partyId: z.string().optional(),
  members: PartyMemberSchema.array().optional(),
...
// Client Party Message Schema
export const ClientPartyMessageSchema = z.object({
  type: z.literal("party"),
  action: PartyActionSchema,
  partyCode: z.string().optional(),
  memberId: z.string(),
  memberName: SafeString.optional(),
  memberFlag: SafeString.optional(),
  gameId: ID.optional(),
});
