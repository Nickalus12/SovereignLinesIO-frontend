...
- All other code is proprietary and closed source
...
This project contains mixed licensing:
- Client code is licensed under GPL v3 (see src/client/LICENSE-GPL.txt)
- Server and core code is proprietary software
...
Thank you for helping make Sovereign Lines better!
